    ...
    <section className="panel">
      <header className="panel-header">
        ...
        <p className="panel-caption">
          Refine the creative brief through conversation. The assistant tracks requirements and
          produces a final written brief.
        </p>
      </header>
          ...
          {messages.length === 0 && (
            ...
            >
              ...
              <p className="text-center mb-4">
                Start by telling the assistant what kind of video you&apos;re creating, for
                example:
              </p>
              <ul className="space-y-2">
                <li className="text-sm text-gray-400">
                  &ldquo;I need a 60s TikTok ad for a fitness app aimed at busy professionals.&rdquo;
                </li>
                <li className="text-sm text-gray-400">
                  &ldquo;Make a YouTube explainer for beginners about my AI editor.&rdquo;
                </li>
              </ul>
            </motion.div>
          )}
